...
public class costumadapterup extends RecyclerView.Adapter<costumadapterup.ViewHolder> {
    private Context context;
    private ArrayList<modelmovie> listmovie=new ArrayList<>();

    costumadapterup(Context context) {
    ...
    @Override
    public costumadapterup.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemRow = LayoutInflater.from(parent.getContext()).inflate(R.layout.layoutitemup, parent, false);
        return new ViewHolder(itemRow);

    }

    @Override
    public void onBindViewHolder(costumadapterup.ViewHolder holder, int position) {
